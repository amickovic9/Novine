    ...
    @foreach ($deleteRequests as $deleteRequest)
        <div class="card mb-3">
            <div class="card-body">
                ...
                <a href="/article/{{ $deleteRequest->news->id }}" class="btn btn-primary mb-2">Vidi članak</a>
                <a href="/cms/delete-request/{{ $deleteRequest->id }}/allow" class="btn btn-success  mb-2">Dozvoli zahtev za brisanje</a>
                <a href="/cms/delete-request/{{ $deleteRequest->id }}/decline" class="btn btn-danger mb-2 ">Odbij zahtev za brisanje</a>
            </div>
        </div>
    @endforeach
</div>
